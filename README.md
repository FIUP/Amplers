...
*Linear programming model directly from RO course*
...
## Usage
Be sure to [download](http://ampl.com/products/solvers/open-source/) one of the AMPL solvers and to add the correct path in the [right place](/models/contadino/model.mod#L18). Then simply
```shell
...
Remember to add a semicolon at the end of *moslty* all commands ..
[![WTF semicolon](https://badges.frapsoft.com/os/v1/open-source.svg?v=103)](https://opensource.org/licenses/Apache-2.0)
